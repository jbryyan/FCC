  ...
  xhr.onload = function(){
    if(xhr.status == 200){
      ...
      if(weatherStatus == "Smoke"){
        if(screen.width < 900){
          document.body.style.backgroundImage = "url(https://res.cloudinary.com/dsusc7zii/image/upload/c_scale,h_1024,w_900/v1504388184/dominik-lange-41376_whmjsc.jpg)";
        }else{
        ...
        if(screen.width < 900){
          document.body.style.backgroundImage = "url(https://res.cloudinary.com/dsusc7zii/image/upload/c_scale,h_1024,w_900/v1504392612/kristopher-kinsinger-29252_fod9fq.jpg)";
        }else{
        ...
        if(screen.width < 900){
          document.body.style.backgroundImage = "url(https://res.cloudinary.com/dsusc7zii/image/upload/c_scale,h_1024,w_900/v1504164867/rachel-lees-267186_x5wvvo.jpg)";
        }else{
        ...
        if(screen.width < 900){
          document.body.style.backgroundImage = "url(https://res.cloudinary.com/dsusc7zii/image/upload/c_scale,h_1024,w_900/v1504164866/sam-mcjunkin-38078_kfevhy.jpg)";
        }else{
        ...
        if(screen.width < 900){
          document.body.style.backgroundImage = "url(https://res.cloudinary.com/dsusc7zii/image/upload/c_scale,h_1024,w_900/v1504392615/veriret-248718_pgxv5f.jpg)";
        }else{
        ...
        if(screen.width < 900){
          document.body.style.backgroundImage = "url(hhttps://res.cloudinary.com/dsusc7zii/image/upload/c_scale,h_1024,w_900/v1504323736/dominik-qn-45994_pn5ak5.jpg)";
        }else{
